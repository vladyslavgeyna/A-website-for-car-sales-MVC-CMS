...
Core::getInstance()->pageParams['title'] = 'Адмін | Редагування оголошення';
    ...
    <div class="content-wrapper container-carad-add">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 style="font-weight: bold; font-size: 40px" class="m-0">Редагування оголошення</h1>
                    </div>
                </div>
            </div>
        </div>
        <section class="content section-carad-edit-admin section-form-admin">
            <div class="container-fluid">
                <?php if (!empty($errors)): ?>
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        <div class="card-body">
                            ...
                            <div class="input-group input-file mb-3">
                                ...
                                <div>
                                    <input  accept="image/jpeg, image/png" multiple type="file" name="car_photos[]" class="form-control d-flex align-items-center h-100" id="exampleInputPhotos">
                                </div>
                            ...
                            <div class="mb-3">
                                ...
                                <select name="car_brand_id" required class="form-select form-control" id="inputCarBrand" >
                            ...
                            <div class="mb-3">
                                ...
                                <select name="car_model_id" required class="form-select form-control" id="inputCarModel" >
                            ...
                            <div class="mb-3">
                                ...
                                <select name="year_of_production" required class="form-select form-control" id="inputCarYearOfProduction" >
                            ...
                            <div class="mb-3">
                                ...
                                <select name="region_id" required class="form-select form-control" id="inputRegion" >
                            ...
                            <div class="mb-3">
                                ...
                                <select name="transmission_id" required class="form-select form-control" id="inputRegion" >
                            ...
                            <div class="mb-3">
                                ...
                                <select name="fuel_id" required class="form-select form-control" id="inputFuel" >
                            ...
                            <div class="mb-3">
                                ...
                                <select name="wheel_drive_id" required class="form-select form-control" id="inputWheelDrive" >
                            ...
                            <div class="mb-3">
                                ...
                                <select name="number_of_seats" required class="form-select form-control" id="inputCarNumberOfSeats" >
                            ...
                            <div class="mb-3">
                                ...
                                <div class="d-flex align-items-center row m-0 flex-row" id="inputPriceWrapper" style="gap: 1rem">
                                    <div class="col p-0">
                                    ...
                                    <div class="col p-0">
                                        <select name="type_of_currency_id" required class="form-select form-control" id="inputCarTypeOfCurrency" >
